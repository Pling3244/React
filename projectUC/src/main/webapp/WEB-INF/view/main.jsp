...
<!--                     <div class="login_button"><a href="/member/login">로그인</a></div> -->
						<a class="h4 mb-0 text-white mx-2 my-auto" href="/member/login">Login </a>
<!--                    			 <a class="h4 mb-0 text-white mx-2 my-auto" href="/member/login">join </a>                 -->
              		    </c:if> 
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="/resources/img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
